Final Fantasy V SPC Disassembly (Akao revision 3)
...
020f: e8 00     mov   a,#$00
0211: 8d 0c     mov   y,#$0c
0213: 3f 55 06  call  $0655
0216: 8d 1c     mov   y,#$1c
0218: 3f 55 06  call  $0655
021b: 8d 2c     mov   y,#$2c
021d: 3f 55 06  call  $0655
0220: 8d 3c     mov   y,#$3c
0222: 3f 55 06  call  $0655
0225: 8d 2d     mov   y,#$2d
0227: 3f 55 06  call  $0655
022a: 8d 3d     mov   y,#$3d
022c: 3f 55 06  call  $0655
022f: 8d 4d     mov   y,#$4d
0231: 3f 55 06  call  $0655
0234: 8d 5d     mov   y,#$5d
0236: e8 1b     mov   a,#$1b
...
0253: 8f 03 f1  mov   $f1,#$03
0256: 3f c8 13  call  $13c8
0259: e8 d2     mov   a,#$d2
025b: 8d 6d     mov   y,#$6d
025d: 3f 55 06  call  $0655
0260: e8 05     mov   a,#$05
0262: 8d 7d     mov   y,#$7d
0264: 3f 55 06  call  $0655
0267: e8 00     mov   a,#$00
0269: eb fe     mov   y,$fe
026b: f0 fc     beq   $0269
026d: bc        inc   a
...
0272: e8 7f     mov   a,#$7f
0274: 8d 0c     mov   y,#$0c
0276: 3f 55 06  call  $0655
0279: 8d 1c     mov   y,#$1c
027b: 3f 55 06  call  $0655
027e: 8f ff bd  mov   $bd,#$ff
0281: 8f 07 ea  mov   $ea,#$07
0284: e2 9c     set7  $9c
0286: e2 9e     set7  $9e
0288: e2 a8     set7  $a8
028a: e2 aa     set7  $aa
028c: 3f 68 0d  call  $0d68
028f: eb fd     mov   y,$fd
0291: f0 f9     beq   $028c
0293: 8d 08     mov   y,#$08          ; update 8 registers
0295: f6 df 19  mov   a,$19df+y       ; dsp register
0298: c4 f2     mov   $f2,a
029a: f6 e7 19  mov   a,$19e7+y       ; dsp value in dp0
029d: 5d        mov   x,a
029e: e6        mov   a,(x)
029f: c4 f3     mov   $f3,a
02a1: fe f2     dbnz  y,$0295
02a3: cb bd     mov   $bd,y
02a5: cb bc     mov   $bc,y
02a7: e3 be 0a  bbs   $be.7,$02b4     ; branch if waveform output
02aa: ba b9     movw  ya,$b9
02ac: da f6     movw  $f6,ya
02ae: e4 d1     mov   a,$d1
02b0: c4 f5     mov   $f5,a
02b2: 2f 03     bra   $02b7
02b4: 3f 39 17  call  $1739           ; update waveform output
02b7: ba d8     movw  ya,$d8
02b9: d0 0a     bne   $02c5
02bb: 8b ea     dec   $ea
02bd: d0 06     bne   $02c5
02bf: 8f 07 ea  mov   $ea,#$07
02c2: 3f 90 17  call  $1790
02c5: 3f 04 03  call  $0304
02c8: cd 00     mov   x,#$00
02ca: 8f 01 bf  mov   $bf,#$01        ; current channel mask
02cd: e4 ba     mov   a,$ba
02cf: 04 bb     or    a,$bb
02d1: 48 ff     eor   a,#$ff
02d3: 24 b9     and   a,$b9
...
02fb: 1d        dec   x
02fc: 4b bf     lsr   $bf
02fe: 73 bf f0  bbc3  $bf,$02f0
0301: 5f 8c 02  jmp   $028c           ; main code loop
...
031d: 84 7e     adc   a,$7e
031f: c4 7e     mov   $7e,a
0321: 33 be 01  bbc   $be.1,$0325     ; branch if not fast forward
0324: 80        setc
0325: 90 5c     bcc   $0383
0327: cd 00     mov   x,#$00
...
039c: 84 7f     adc   a,$7f
039e: c4 7f     mov   $7f,a
03a0: 33 be 01  bbc   $be.1,$03a4     ; branch if not fast forward
03a3: 80        setc
03a4: 90 40     bcc   $03e6
03a6: cd 18     mov   x,#$18
...
03e7: 3f 9c 05  call  $059c           ; get next parameter
03ea: 68 d2     cmp   a,#$d2
03ec: 90 05     bcc   $03f3
...
03f7: 9e        div   ya,x
03f8: f8 05     mov   x,$05
03fa: f6 2f 19  mov   a,$192f+y       ; note duration
...
0531: 1c        asl   a
0532: fd        mov   y,a
0533: f6 f5 18  mov   a,$18f5+y    ; Note Tuning Table
0536: c4 0a     mov   $0a,a
...
058a: 1c        asl   a
058b: fd        mov   y,a
058c: f6 2c 18  mov   a,$182c+y       ; channel command jump table
058f: 2d        push  a
...
0595: 5c        lsr   a
0596: fd        mov   y,a
0597: f6 87 18  mov   a,$1887+y       ; number of parameters
059a: f0 0a     beq   $05a6
; fall through

; [ get next parameter ]

059c: e7 0c     mov   a,($0c+x)       ; copy the first parameter
059e: c4 04     mov   $04,a
05a0: bb 0c     inc   $0c+x
05a2: d0 02     bne   $05a6
05a4: bb 0d     inc   $0d+x
...
0667: c4 80     mov   $80,a
0669: 3f 9c 05  call  $059c           ; get next parameter
066c: c8 10     cmp   x,#$10
066e: b0 2e     bcs   $069e
0670: eb 80     mov   y,$80
0672: f0 e6     beq   $065a
...
; [ channel command $f8: set master volume ]
...
06b3: 3f 9c 05  call  $059c           ; get next parameter
06b6: eb 34     mov   y,$34
06b8: f0 e8     beq   $06a2
06ba: 80        setc
...
06f7: c4 b7     mov   $b7,a
06f9: 3f 9c 05  call  $059c           ; get next parameter
06fc: c8 10     cmp   x,#$10
06fe: b0 2f     bcs   $072f
0700: eb b7     mov   y,$b7
0702: f0 e6     beq   $06ea
...
073c: c4 34     mov   $34,a
073e: d5 81 fa  mov   $fa81+x,a       ; set pan counter
0741: 3f 9c 05  call  $059c           ; get next parameter
0744: eb 34     mov   y,$34
0746: f0 e8     beq   $0730
0748: 80        setc
...
076b: 3a 34     incw  $34
076d: e4 34     mov   a,$34
076f: d5 60 fa  mov   $fa60+x,a       ; set pan rate
0772: e4 35     mov   a,$35
...
; b1: envelope duration
; b1: final pitch value

0778: bc        inc   a
0779: d5 c1 fa  mov   $fac1+x,a
077c: 3f 9c 05  call  $059c           ; get next parameter
...
; [ channel command $f7: set echo filter ]

078b: c4 d5     mov   $d5,a
078d: 3f 9c 05  call  $059c           ; get next parameter
0790: c8 10     cmp   x,#$10
0792: 90 01     bcc   $0795
0794: 6f        ret
0795: 28 03     and   a,#$03
...
079c: fd        mov   y,a
079d: cd 0f     mov   x,#$0f
079f: f6 0f 19  mov   a,$190f+y       ; echo filter values
07a2: d8 f2     mov   $f2,x
07a4: c4 f3     mov   $f3,a
07a6: fc        inc   y
07a7: 7d        mov   a,x
...
07d0: 3f 9c 05  call  $059c           ; get next parameter
07d3: bc        inc   a
07d4: d5 a1 fa  mov   $faa1+x,a
07d7: e8 01     mov   a,#$01
07d9: d5 e1 fa  mov   $fae1+x,a
07dc: 3f 9c 05  call  $059c           ; get next parameter
; fall through
...
07f2: fd        mov   y,a
07f3: 3f 9c 05  call  $059c           ; get next parameter
07f6: 1c        asl   a
07f7: e4 04     mov   a,$04
07f9: 28 7f     and   a,#$7f
07fb: 90 02     bcc   $07ff
...
08a6: e4 bf     mov   a,$bf
08a8: c8 10     cmp   x,#$10
08aa: b0 05     bcs   $08b1             ; branch if sfx
...
; [ channel command $ea: change sample ]

08f5: d4 5d     mov   $5d+x,a
08f7: 1c        asl   a
08f8: fd        mov   y,a
08f9: f6 00 1a  mov   a,$1a00+y       ; pitch multiplier (lo)
08fc: d5 20 fb  mov   $fb20+x,a
08ff: f6 01 1a  mov   a,$1a01+y
0902: d5 21 fb  mov   $fb21+x,a
0905: f6 80 1a  mov   a,$1a80+y       ; adsr value
...
0994: 2f 99     bra   $092f
0996: fd        mov   y,a
0997: 3f 9c 05  call  $059c           ; get next parameter
099a: c8 10     cmp   x,#$10
099c: b0 09     bcs   $09a7
099e: dd        mov   a,y
099f: eb 04     mov   y,$04
...
09a8: c4 36     mov   $36,a
09aa: 3f 9c 05  call  $059c           ; get next parameter
09ad: c4 34     mov   $34,a
09af: 3f 9c 05  call  $059c           ; get next parameter
09b2: c4 35     mov   $35,a
09b4: c8 10     cmp   x,#$10
09b6: b0 14     bcs   $09cc
...
09d1: 60        clrc
09d2: 88 04     adc   a,#$04
09d4: de 5c 05  cbne  $5c+x,$09dc     ; branch if not at max loop depth
09d7: 80        setc
09d8: a8 04     sbc   a,#$04          ; decrease loop depth by 4
09da: d4 5c     mov   $5c+x,a
09dc: fb 5c     mov   y,$5c+x
09de: e4 04     mov   a,$04
09e0: f0 01     beq   $09e3
09e2: bc        inc   a
09e3: d6 c0 fc  mov   $fcc0+y,a       ; set loop count
09e6: c8 10     cmp   x,#$10
09e8: b0 05     bcs   $09ef
09ea: e8 00     mov   a,#$00
...
09f0: 1c        asl   a
09f1: fd        mov   y,a
09f2: f4 0c     mov   a,$0c+x         ; set loop script pointer
09f4: d6 00 fd  mov   $fd00+y,a
09f7: f4 0d     mov   a,$0d+x
09f9: d6 01 fd  mov   $fd01+y,a
09fc: 6f        ret

; [ channel command $f1: loop end ]

09fd: fb 5c     mov   y,$5c+x         ; loop depth
09ff: f6 c0 fc  mov   a,$fcc0+y       ; loop count
0a02: f0 15     beq   $0a19
0a04: 9c        dec   a
0a05: d0 0f     bne   $0a16
0a07: 7d        mov   a,x
...
0a1a: 1c        asl   a
0a1b: fd        mov   y,a
0a1c: f6 00 fd  mov   a,$fd00+y       ; go to loop start
...
0a27: fd        mov   y,a
0a28: 3f 9c 05  call  $059c           ; get next parameter
0a2b: c8 10     cmp   x,#$10
0a2d: b0 12     bcs   $0a41
0a2f: e4 bf     mov   a,$bf
0a31: 24 d1     and   a,$d1
...
0c00: 03 be 3e  bbs   $be.0,$0c41     ; branch if mono
0c03: e4 bf     mov   a,$bf
0c05: 24 bb     and   a,$bb
0c07: d0 38     bne   $0c41
0c09: c8 10     cmp   x,#$10
...
0c77: c8 10     cmp   x,#$10
0c79: 90 06     bcc   $0c81
0c7b: aa be 60  mov1  c,$be.3
0c7e: ca 34 00  mov1  $34.0,c
0c81: e4 36     mov   a,$36
0c83: fd        mov   y,a
0c84: c8 10     cmp   x,#$10
0c86: b0 01     bcs   $0c89
...
; [ calculate vibrato/tremolo amplitude ]

; $34: -----abc envelope counter
;      a: multiply by 3/4
;      b: multiply by 1/2
;      c: multiply by 1/4
; $35: amplitude (also in y)
;      npaaaaaa
;      n: negative oscillations (set n & p for balanced, negative if both are zero)
;      p: positive oscillations
;      a: amplitude ($00 ~= 5.55 cents, $3f ~= 705 cents)
; $36: previous multiplier (msb ???)

;   a: new multiplier (out)

; +-------------------------------------------------------------------------+
; |       delay      envelope (3 cycles)                                    |
; |   |<--------->|<----->|<----->|<----->|<----->|<----->|                 |
...
; 00 -> 00, 88, 80, 90, 80, a1, 80, a1, 80, ... (negative amplitude)
; 01 -> 00, 08, 00, 10, 00, 21, 00, 21, 00, ... (positive amplitude)
; 10 -> 00, 88, 80, 90, 80, a1, 80, a1, 80, ... (same as 00)
; 11 -> 80, 08, 88, 10, 90, 21, a1, 21, a1, ... (balanced amplitude)
...
0d18: 28 3f     and   a,#$3f
0d1a: 1c        asl   a
0d1b: bc        inc   a               ; a = amplitude magnitude
0d1c: f3 35 09  bbc7  $35,$0d28
0d1f: d3 35 06  bbc6  $35,$0d28
0d22: f3 36 3e  bbc7  $36,$0d63       ; use negative value
0d25: 8f 00 36  mov   $36,#$00        ; only go positive ???
0d28: 0b 36     asl   $36
0d2a: d0 29     bne   $0d55
0d2c: eb 34     mov   y,$34
0d2e: f0 27     beq   $0d57
...
0d53: 2f 02     bra   $0d57
0d55: e8 00     mov   a,#$00
0d57: 38 40 35  and   $35,#$40        ; ~$35.6 -> a.7
0d5a: 0b 35     asl   $35
0d5c: 58 80 35  eor   $35,#$80
0d5f: 04 35     or    a,$35
0d61: 2f 04     bra   $0d67
0d63: e4 36     mov   a,$36
0d65: 08 80     or    a,#$80          ; negative value
0d67: 6f        ret
...
0d74: c4 f4     mov   $f4,a
0d76: 64 f4     cmp   a,$f4
0d78: f0 fc     beq   $0d76           ; wait for snes
0d7a: 5d        mov   x,a
0d7b: 10 0d     bpl   $0d8a
0d7d: c8 fe     cmp   x,#$fe
0d7f: d0 03     bne   $0d84
0d81: 5f db 12  jmp   $12db           ; data transfer
0d84: 8f 00 f4  mov   $f4,#$00
0d87: 5f fe 0f  jmp   $0ffe           ; interrupts $8x and $fx
0d8a: c8 01     cmp   x,#$01
0d8c: f0 1a     beq   $0da8
0d8e: c8 03     cmp   x,#$03
0d90: f0 16     beq   $0da8
...
0da0: c8 20     cmp   x,#$20
0da2: b0 03     bcs   $0da7
0da4: 5f a5 0f  jmp   $0fa5           ; execute interrupt
0da7: 6f        ret

; [ interrupt command $01/$03: play song ]

0da8: e8 ff     mov   a,#$ff
0daa: 8d 5c     mov   y,#$5c          ; set key off for all channels
...
0de4: c4 c6     mov   $c6,a
0de6: c4 c7     mov   $c7,a
0de8: 32 be     clr1  $be.1           ; disable fast forward
...
0e76: f0 0c     beq   $0e84
0e78: 09 bf b9  or    $b9,$bf         ; activate channel
...
0eb2: cd ff     mov   x,#$ff          ; reset stack pointer
0eb4: bd        mov   sp,x
0eb5: e4 fd     mov   a,$fd
0eb7: 5f 8c 02  jmp   $028c           ; main code loop
...
; [ interrupt command $02: sound effect ]
...
0eec: 0b 2c     asl   $2c
0eee: 2b 2d     rol   $2d
0ef0: e8 00     mov   a,#$00          ; add $2c00
0ef2: 8d 2c     mov   y,#$2c
0ef4: 7a 2c     addw  ya,$2c
0ef6: da 2c     movw  $2c,ya          ; ($2c) = pointer to sound effect script
0ef8: cd 1e     mov   x,#$1e          ; start in sfc channel 7
...
0f09: 24 bf     and   a,$bf
0f0b: d0 07     bne   $0f14
0f0d: 4b bf     lsr   $bf             ; go to next sfx channel
0f0f: 1d        dec   x
0f10: 1d        dec   x
0f11: b3 bf f3  bbc5  $bf,$0f07       ; 
0f14: 8d 03     mov   y,#$03          ; loop through 2 voices
0f16: 8f 00 03  mov   $03,#$00
0f19: f7 2c     mov   a,($2c)+y       ; copy channel script pointer
0f1b: f0 2c     beq   $0f49           ; branch if no script for this voice
...
0f2a: bb 3c     inc   $3c+x
0f2c: e8 60     mov   a,#$60          ; set volume
0f2e: d5 01 fa  mov   $fa01+x,a
0f31: e8 80     mov   a,#$80          ; pan to center
0f33: d5 41 fa  mov   $fa41+x,a
0f36: e8 00     mov   a,#$00          ; clear volume/pan envelope counters
0f38: d5 80 fa  mov   $fa80+x,a
0f3b: d5 81 fa  mov   $fa81+x,a
0f3e: 6d        push  y
0f3f: 3f f5 08  call  $08f5
0f42: ee        pop   y               ; next voice
0f43: 1d        dec   x
0f44: 1d        dec   x
0f45: 4b bf     lsr   $bf
0f47: 2f 01     bra   $0f4a
...
0fd2: f6 3f 19  mov   a,$193f+y       ; pointers to system sound effects
0fd5: f0 26     beq   $0ffd
...
1020: cd 00     mov   x,#$00
1022: e4 c1     mov   a,$c1
1024: 13 c1 03  bbc0  $c1,$102a       ; branch if command $81
1027: bc        inc   a
1028: 2f 0d     bra   $1037
102a: 33 c1 05  bbc1  $c1,$1032       ; branch if command $80
102d: bc        inc   a
102e: cd 02     mov   x,#$02
1030: 2f 05     bra   $1037
1032: ab c1     inc   $c1
...
; [ interrupt command $f3/$f4: change to mono/stereo ]

1214: 13 c1 04  bbc   $c1.0,$121b
1217: 12 be     clr1  $be.0
1219: 2f 02     bra   $121d
121b: 02 be     set1  $be.0
121d: 8f ff d6  mov   $d6,#$ff
1220: 6f        ret

; [ interrupt command $f0:  ]
...
; [ interrupt command $f5: mute/unmute channels ]

126b: fa c2 c0  mov   $c0,$c2
126e: 8f ff d6  mov   $d6,#$ff
1271: 6f        ret

; [ interrupt command $fb:  ]

1272: fa b9 d1  mov   $d1,$b9
1275: 6f        ret

; [ interrupt command $fc:  ]

1276: 60        clrc
1277: e8 ff     mov   a,#$ff
1279: 84 c2     adc   a,$c2
127b: ca be 60  mov1  $be.3,c
127e: 6f        ret

; [ interrupt command $f6/$f7:  ]
...
; [ interrupt command $fe: data transfer ]

12db: e4 f5     mov   a,$f5
12dd: c4 04     mov   $04,a
12df: 28 07     and   a,#$07          ; transfer command
12e1: c4 f5     mov   $f5,a
12e3: d0 04     bne   $12e9
12e5: d8 f4     mov   $f4,x
12e7: 2f 1b     bra   $1304
...
12ed: da 2c     movw  $2c,ya          ; source address
12ef: ee        pop   y
12f0: f6 1c 18  mov   a,$181c+y       ; transfer command jump table
12f3: 2d        push  a
...
; [ transfer command $03: three bytes at a time ]
...
; [ transfer command $02: two bytes at a time ]
...
; [ transfer command $01: one byte at a time ]
...
; [ transfer command $00: no transfer ]
...
; [ transfer command $07: move chunk ]

135a: ba f6     movw  ya,$f6
135c: da 2e     movw  $2e,ya          ; transfer destination
135e: d8 f4     mov   $f4,x
1360: 3e f4     cmp   x,$f4
1362: f0 fc     beq   $1360
1364: f8 f4     mov   x,$f4
1366: ba f6     movw  ya,$f6
1368: da 34     movw  $34,ya          ; transfer size
136a: d8 f4     mov   $f4,x
136c: 8d 00     mov   y,#$00
...
1381: f8 f4     mov   x,$f4
1383: f0 0e     beq   $1393
1385: ba f6     movw  ya,$f6          ; transfer another chunk
...
; [ interrupt command $f8/$f9/$fa: enable/disable fast forward ]

1396: ea c1 20  not1  $c1.1
1399: aa c1 20  mov1  c,$c1.1
139c: ca be 20  mov1  $be.1,c
139f: b0 04     bcs   $13a5
13a1: e8 24     mov   a,#$24
13a3: 2f 02     bra   $13a7
13a5: e8 01     mov   a,#$01
13a7: 8f 00 f1  mov   $f1,#$00
13aa: c4 fa     mov   $fa,a           ; set timer 0
13ac: 8f 01 f1  mov   $f1,#$01
13af: 6f        ret

; [ interrupt command $ff: enable waveform output mode ]

13b0: e8 ff     mov   a,#$ff          ; disable unless ports read $ff,$fe,$fd,$fc
13b2: 8d fe     mov   y,#$fe
...
; [ interrupt command $8c/$8d/$8e/$8f: unused ]
...
1739: e8 34     mov   a,#$34          ; scratchpad location for waveform values (4 bytes)
173b: c4 39     mov   $39,a
173d: e8 da     mov   a,#$da          ; dsp volume for each channel
173f: 8f 00 03  mov   $03,#$00
1742: 43 be 05  bbs   $be.2,$174a     ; branch if channels 4-7
1745: 8f 09 bf  mov   $bf,#$09        ; outx for channel 0
1748: 2f 08     bra   $1752
174a: 8f 49 bf  mov   $bf,#$49        ; outx for channel 4
174d: 60        clrc
174e: 88 08     adc   a,#$08
1750: e2 03     set7  $03
1752: c4 3a     mov   $3a,a
1754: 60        clrc
1755: 88 08     adc   a,#$08
1757: c4 02     mov   $02,a           ; $02 is the where to stop (do 4 channels)
1759: f8 3a     mov   x,$3a
175b: eb bf     mov   y,$bf
175d: cb f2     mov   $f2,y
175f: eb f3     mov   y,$f3           ; y = outx
1761: 6d        push  y
1762: bf        mov   a,(x)+          ; multiply by channel volume (l)
1763: cf        mul   ya
1764: dd        mov   a,y
1765: 28 70     and   a,#$70
1767: c4 38     mov   $38,a
1769: ee        pop   y
176a: bf        mov   a,(x)+          ; multiply by channel volume (l)
176b: cf        mul   ya
176c: dd        mov   a,y
176d: d8 3a     mov   $3a,x           ; save dsp register pointer
176f: f8 39     mov   x,$39
1771: 9f        xcn   a
1772: 28 07     and   a,#$07          ; lo nybble = right (3 bits, unsigned)
1774: 04 38     or    a,$38           ; hi nybble = left
1776: 04 03     or    a,$03           ; set msb for channels 4-7
1778: af        mov   (x)+,a          ; copy to scratchpad
1779: d8 39     mov   $39,x
177b: 60        clrc
177c: 98 10 bf  adc   $bf,#$10        ; next channel
177f: 69 02 3a  cmp   $3a,$02
1782: d0 d5     bne   $1759
1784: ba 34     movw  ya,$34          ; copy values to output ports
1786: da f4     movw  $f4,ya
1788: ba 36     movw  ya,$36
178a: da f6     movw  $f6,ya
178c: 58 04 be  eor   $be,#$04        ; toggle waveform channels to output ($be.2)
178f: 6f        ret
...
181b: 4d 13    ; ($134d) $00 No Transfer
181d: 3b 13    ; ($133b) $01 Transfer one byte at a time
181f: 23 13    ; ($1323) $02 Transfer two bytes at a time
1821: 05 13    ; ($1305) $03 Transfer three bytes at a time
1823: 4d 13    ;         $04 Unused
1825: 4d 13    ;         $05 Unused
1827: 4d 13    ;         $06 Unused
1829: 5a 13    ; ($135A) $07 Move chunk

Jump Table for Track Commands
182b: a2 06    ; $D2 Volume
182d: ae 06    ; $D3 Volume Fade
182f: 30 07    ; $D4 Pan
1831: 3c 07    ; $D5 Pan Fade
1833: 78 07    ; $D6 Pitch Slide
1835: b7 07    ; $D7 Vibrato On
1837: c9 07    ; $D8 Vibrato Off
1839: cd 07    ; $D9 Tremolo On
183b: df 07    ; $DA Tremolo Off
183d: e3 07    ; $DB Pan LFO On
183f: 34 08    ; $DC Pan LFO Off
1841: be 08    ; $DD Noise Freq
...
184f: 4a 08    ; $E4 Octave
1851: 40 08    ; $E5 Octave Up
1853: 46 08    ; $E6 Octave Down
1855: 87 07    ; $E7 Transpose ABS
1857: 83 07    ; $E8 Transpose REL
1859: 42 0a    ; $E9 Tuning
185b: f5 08    ; $EA Progchange
185d: 1f 09    ; $EB ADSR Attack Rate
185f: 4f 09    ; $EC ADSR Decay Rate
1861: 62 09    ; $ED ADSR Sustain Level
1863: 74 09    ; $EE ADSR Release Rate
1865: 84 09    ; $EF ADSR Default
1867: cd 09    ; $F0 Loop Start
1869: fd 09    ; $F1 Loop End
186b: 46 0a    ; $F2 End of Script
186d: 5a 06    ; $F3 Tempo
186f: 67 06    ; $F4 Tempo Fade
1871: ea 06    ; $F5 Echo Volume
1873: f7 06    ; $F6 Echo Volume Fade
1875: 8b 07    ; $F7 Echo Feedback FIR
1877: 9f 06    ; $F8 Master Volume
1879: a8 09    ; $F9 Loop Break
187b: 96 09    ; $FA Goto
187d: 27 0a    ; $FB CPU Controled jump
187f: 46 0a    ; $FC (End of Script)
1881: 46 0a    ; $FD (End of Script)
1883: 46 0a    ; $FE (End of Script)
1885: 46 0a    ; $FF (End of Script)

; number of parameters for each track command
1887: 01       ; $D2
1888: 02       ; $D3
1889: 01       ; $D4
188a: 02       ; $D5
...
; echo filter values
190f: 7f 00 00 00 00 00 00 00        ; Set 0
1917: 0c 21 2b 2b 13 fe f3 f9        ; Set 1
191f: 58 bf db f0 fe 07 0c 0c        ; Set 2
1927: 34 33 00 d9 e5 01 fc eb        ; Set 3
...
; system sound effect jump table
193e: 5e 19    ; $10
1940: 69 19    ; $11
1942: 74 19    ; $12
1944: 82 19    ; $13
1946: 00 00    ; $14 Unused
1948: 00 00    ; $15 Unused
194a: 00 00    ; $16 Unused
194c: 00 00    ; $17 Unused
194e: 94 19    ; $18
1950: ad 19    ; $19
1952: c5 19    ; $1A
1953: 00 00    ; $1B Unused
1956: 00 00    ; $1C Unused
1958: 00 00    ; $1D Unused
195a: 00 00    ; $1E Unused
195c: d4 19    ; $1F

System Sound Effect $10
195e: d2 78     
1960: ea 05 d6  
1963: 06        
1964: 0c e4 06  
...
Data: Initial DSP Registers
19e0: 4c 5c 2d 3d 4d 2c 3c 6c

Data: Initial DSP Registers Data
